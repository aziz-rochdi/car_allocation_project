...
<body>
    ...
    <section>
        <section class="photo-gallery">
            <div class="container">
                <div class="intro">
                    <h2 class="text-center"><br>welcome to our site web<br></h2>
                    <p class="text-center"><br>you search for a confortable car , white a confortable price, congratulations you are in the right place&nbsp;<br>thos are some of our beautiful cars, fell free to watch them or go to the Cars section where you well find more.</p>
                </div>
